...
It is already separated and placed into the **[freecad directory](./freecad/)** as STLs and the original project file.
...
The sensors only has an **input (voltage divider)** and **GND**
